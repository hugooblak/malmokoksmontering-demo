...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'malmokoksmontering-leads' ),
				'storm'       => __( 'Storm or hail damage', 'malmokoksmontering-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'malmokoksmontering-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'malmokoksmontering-leads' ),
				'not-sure'    => __( 'Vet inte än', 'malmokoksmontering-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'malmokoksmontering-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'malmokoksmontering-leads' ),
				'research' => __( 'Jag kollar bara priser', 'malmokoksmontering-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'malmokoksmontering-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'malmokoksmontering-leads' ),
		'contacted' => __( 'Kontaktad', 'malmokoksmontering-leads' ),
		'quoted'    => __( 'Quote sent', 'malmokoksmontering-leads' ),
		'won'       => __( 'Won', 'malmokoksmontering-leads' ),
		'lost'      => __( 'Lost', 'malmokoksmontering-leads' ),
		'spam'      => __( 'Misstänkt spam', 'malmokoksmontering-leads' ),
	);
}
