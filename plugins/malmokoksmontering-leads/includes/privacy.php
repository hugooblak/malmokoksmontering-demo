...
add_filter(
	...
	function ( $exporters ) {
		$exporters['malmokoksmontering-leads'] = array(
			'exporter_friendly_name' => __( 'Quote requests', 'malmokoksmontering-leads' ),
			'callback'               => function ( $email ) {
				$items = array();
				foreach ( npl_leads_by_email( $email ) as $lead ) {
					$data = array( array( 'name' => __( 'Received', 'malmokoksmontering-leads' ), 'value' => $lead->post_date ) );
					...
					$items[] = array(
						'group_id'    => 'malmokoksmontering-leads',
						'group_label' => __( 'Quote requests', 'malmokoksmontering-leads' ),
...
add_filter(
	...
	function ( $erasers ) {
		$erasers['malmokoksmontering-leads'] = array(
			'eraser_friendly_name' => __( 'Quote requests', 'malmokoksmontering-leads' ),
			'callback'             => function ( $email ) {
				$removed = false;
				foreach ( npl_leads_by_email( $email ) as $lead ) {
