<?php
/**
 * Malmö Köksmontering AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "Malmö Köksmontering AB Leads" plugin, so leads survive a theme change.
 *
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'malmokoksmontering', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'malmokoksmontering' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'malmokoksmontering' ) ) );

		register_block_pattern_category( 'malmokoksmontering-sections', array( 'label' => __( 'Malmö Köksmontering AB sections', 'malmokoksmontering' ) ) );
		register_block_pattern_category( 'malmokoksmontering-pages', array( 'label' => __( 'Malmö Köksmontering AB page layouts', 'malmokoksmontering' ) ) );
	}
);
