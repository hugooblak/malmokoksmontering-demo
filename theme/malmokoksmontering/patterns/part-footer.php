...
/**
 * Title: Part: sidfot
 * Slug: malmokoksmontering/part-footer
 * Inserter: no
 *
...
<p class="has-text-align-center ma-footer-note has-small-font-size" style="margin-top:var(--wp--preset--spacing--50)">Malmö Köksmontering AB AB · Demosajt byggd som förslag. Bilder och omdömen är platshållare.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
